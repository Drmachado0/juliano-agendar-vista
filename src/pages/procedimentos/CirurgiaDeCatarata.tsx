  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Anos depois, alguns pacientes podem desenvolver opacificação da cápsula posterior — também chamada de catarata secundária —, que causa embaçamento similar ao da catarata. Nesses casos, a indicação pode ser a capsulotomia YAG Laser, um procedimento rápido e indolor realizado no consultório. Saiba mais sobre a capsulotomia YAG Laser.",
      ],
      bullets: [
