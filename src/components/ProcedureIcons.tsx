...
export const TonometriaIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClass(className)}>
    ...
    {/* pressure ripple */}
    <circle className="pa-ripple" cx="22" cy="28" r="5" stroke="hsl(var(--accent))" strokeWidth="1.4" />
    <circle className="pa-breathe" cx="22" cy="28" r="2" fill="hsl(var(--primary))" opacity="0.7" />
    {/* tonometer arrow (nudges toward the eye) */}
    <g className="pa-nudge">
...
export const GonioscopiaIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClass(className)}>
    ...
    <circle className="pa-breathe" cx="24" cy="28" r="2.5" fill="hsl(var(--primary))" opacity="0.6" />
    <path className="pa-focus" d="M16 10L24 18L32 10Z" stroke="hsl(var(--accent))" strokeWidth="1.5" fill="hsl(var(--accent))" fillOpacity="0.12" strokeLinejoin="round" />
    <line className="pa-dashflow" x1="18" y1="14" x2="14" y2="10" stroke="hsl(var(--primary))" strokeWidth="1" opacity="0.6" strokeDasharray="2 2" />
    <line className="pa-dashflow" x1="30" y1="14" x2="34" y2="10" stroke="hsl(var(--primary))" strokeWidth="1" opacity="0.6" strokeDasharray="2 2" />
  </svg>
);
...
export const BiometriaIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClass(className)}>
    ...
    <circle className="pa-breathe" cx="24" cy="24" r="2.5" fill="hsl(var(--primary))" opacity="0.6" />
    <path className="pa-wave1" d="M36 18C38 20 38 28 36 30" stroke="hsl(var(--accent))" strokeWidth="1.5" strokeLinecap="round" fill="none" />
    <path className="pa-wave2" d="M39 16C42 19 42 29 39 32" stroke="hsl(var(--accent))" strokeWidth="1.2" strokeLinecap="round" fill="none" opacity="0.7" />
    <path className="pa-wave3" d="M42 14C46 18 46 30 42 34" stroke="hsl(var(--accent))" strokeWidth="1" strokeLinecap="round" fill="none" opacity="0.4" />
...
export const CatarataIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClass(className)}>
    ...
    <ellipse className="pa-focus" cx="24" cy="24" rx="5" ry="3" stroke="hsl(var(--accent))" strokeWidth="2" />
    ...
    <path className="pa-twinkle" d="M22 22.5L23 21.5" stroke="white" strokeWidth="1.4" strokeLinecap="round" opacity="0.8" />
    <circle className="pa-breathe" cx="24" cy="24" r="1.5" fill="hsl(var(--primary))" opacity="0.5" />
  </svg>
);
...
export const PterigioIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className={svgClass(className)}>
    ...
    <circle cx="24" cy="24" r="7" stroke="hsl(var(--primary))" strokeWidth="2" />
    <circle className="pa-breathe" cx="24" cy="24" r="2.5" fill="hsl(var(--primary))" opacity="0.6" />
    <path className="pa-focus" d="M6 24L14 22L18 24L14 26Z" fill="hsl(var(--accent))" fillOpacity="0.2" stroke="hsl(var(--accent))" strokeWidth="1.2" />
