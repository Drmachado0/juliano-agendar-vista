      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="pt-8 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a <a href="https://api.whatsapp.com/send?phone=5591936180476" target="_blank" rel="noopener noreferrer" onClick={() => trackWhatsAppClickConversion()} className="text-muted-foreground hover:text-primary transition-colors" aria-label="WhatsApp"> target="_blank" rel="noopener noreferrer" onClick={() => trackWhatsAppClickConversion()} className="text-muted-foreground hover:text-primary transition-colors" aria-label="WhatsApp">
