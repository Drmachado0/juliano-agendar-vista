          ...
          <div className={`relative overflow-hidden rounded-3xl transition-all duration-700 delay-300 ease-out-expo ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            ...
            <div className="relative p-10 md:p-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
                ...
                <a
                  href="https://wa.me/5591991150174?text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20consulta%20com%20o%20Dr.%20Juliano%20Machado."
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => {
                    trackWhatsAppClick(
                      'https://wa.me/5591991150174?text=Ol%C3%A1!%20Gostaria%20de%20agendar%20uma%20consulta%20com%20o%20Dr.%20Juliano%20Machado.',
                      'Falar no WhatsApp',
