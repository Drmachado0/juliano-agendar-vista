...
// BM:    310813633246152 (Juliano Machado) — mesma BM da conta Anuncios_DrJuliano
//
// Recebe payload de evento, hashea PII (SHA-256), captura IP real e User Agent,
// e envia para Meta CAPI com event_id que faz dedup com o pixel browser
// (carregado direto pelo site em src/lib/metaPixel.ts após consentimento).
//
